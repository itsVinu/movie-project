...
import com.example.movieproject.Model.MovieModel.topratedresponse.ResultsItem
import com.example.movieproject.R
import com.squareup.picasso.Picasso
import kotlinx.android.synthetic.main.slider.view.*

class TopRatedMovieAdapter(val list: List<ResultsItem>):
    RecyclerView.Adapter<TopRatedMovieAdapter.UserViewHolder>() {
