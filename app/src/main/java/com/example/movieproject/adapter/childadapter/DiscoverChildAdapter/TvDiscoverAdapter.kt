package com.example.movieproject.adapter.childadapter.DiscoverChildAdapter

import android.view.LayoutInflater
import android.view.View
import android.view.ViewGroup
import androidx.recyclerview.widget.RecyclerView
import com.example.movieproject.DiscoverModel.discovertvresponse.ResultsItem
import com.example.movieproject.R
import com.squareup.picasso.Picasso
import kotlinx.android.synthetic.main.slider.view.*

class TvDiscoverAdapter(val list: List<ResultsItem>):
    RecyclerView.Adapter<TvDiscoverAdapter.UserViewHolder>() {
