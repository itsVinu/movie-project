...
class DisplayMovieDiscoverAdapter(val list: List<ResultsItem>):
    RecyclerView.Adapter<DisplayMovieDiscoverAdapter.UserViewHolder>() {
    ...
    inner class UserViewHolder(itemView: View): RecyclerView.ViewHolder(itemView){
        ...
        fun bind(user: ResultsItem) {
            itemView.apply {
                sliderPeopleTv1.text = user.originalTitle
