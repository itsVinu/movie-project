...
import com.example.movieproject.Model.MovieModel.upcomingresponse.ResultsItem
import com.example.movieproject.R
import com.squareup.picasso.Picasso
import kotlinx.android.synthetic.main.slider_people.view.*

class DisplayUpcomingMovieAdapter(val list: List<ResultsItem>):
    RecyclerView.Adapter<DisplayUpcomingMovieAdapter.UserViewHolder>() {
