...
import com.example.movieproject.Model.TvModel.tvontheairresponse.ResultsItem
import com.squareup.picasso.Picasso
import kotlinx.android.synthetic.main.slider_people.view.*

class DisplayOnTheAirTvAdapter(val list: List<ResultsItem>):
    RecyclerView.Adapter<DisplayOnTheAirTvAdapter.UserViewHolder>() {
