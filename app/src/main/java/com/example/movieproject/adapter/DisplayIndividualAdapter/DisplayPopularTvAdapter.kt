...
import com.example.movieproject.Model.TvModel.tvpopularresponse.ResultsItem
import com.squareup.picasso.Picasso
import kotlinx.android.synthetic.main.slider_people.view.*

class DisplayPopularTvAdapter(val list: List<ResultsItem>):
    RecyclerView.Adapter<DisplayPopularTvAdapter.UserViewHolder>() {
